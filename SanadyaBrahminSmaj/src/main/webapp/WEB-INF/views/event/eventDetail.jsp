<%@ page contentType="text/html; charset=UTF-8" %>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="event-card p-0">
                                                    ...
                                                    <div class="event-carousel-wrap mb-0">
                                                        <div id="carousel-${event.id}" class="carousel slide"
                                                            ...
                                                            <div class="carousel-inner">
                                                                ...
                                                                <c:forEach var="img" items="${event.images}">
                                                            ...
                                                            <c:if
                                                                test="${(not empty event.mainImageUrl and fn:length(event.images) > 0) or (fn:length(event.images) > 1)}">
                                                    ...
                                                    <!-- Details Section -->
                                                    <div class="event-details-bottom p-3 bg-white rounded-bottom">
 ...
 <div class="mb-1">
                                                            <span class="badge event-badge me-2"
                                                                ...
                                                                <c:out value="${event.author}" />

                                                            </span>
                                                            <span class="badge event-badge-date me-2">कार्यक्रम
                                                                तिथि:
                                                            ...
                                                            <span class="badge event-badge me-2"
                                                                ...
                                                                <c:out value="${event.publishDate}" />

                                                            </span></div>
                                                        <c:set var="trimmedContent" value="${event.content}" />
                                                        ...
                                                        <div class="mb-1">
                                                            ...
                                                            <div class="mt-4">
                                                                ...
                                                                <a href="/events" class="btn btn-secondary">← Back to
                                                                    event</a>
                                                            </div>
                                                        </div>
