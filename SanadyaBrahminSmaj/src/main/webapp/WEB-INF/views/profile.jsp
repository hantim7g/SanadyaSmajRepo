                ...
                <div class="col-md-9">
                    <form id="profileForm">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4"><label class="label-col">आधार नंबर</label><input name="aadharNumber" type="text" class="form-control" value="${user.maskedAadharNumber}" maxlength="12" inputmode="numeric" placeholder="12 अंकों का आधार नंबर दर्ज करें" ></div>
